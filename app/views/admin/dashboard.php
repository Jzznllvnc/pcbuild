<div class="container mx-auto p-8 pb-10 pt-20 bg-white shadow-lg rounded-lg mt-40 mb-20 max-w-4xl">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <a href="/pcbuild/public/admin/users" class="p-6 bg-gray-50 border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 hover:shadow-lg transition-all duration-200 flex flex-col items-center justify-center text-center">
