<div class="container mx-auto p-4 md:p-8 mt-24 mb-8 max-w-full min-h-screen">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <a href="/pcbuild/public/admin/products" class="flex-1 p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 hover:shadow-lg transition-all duration-200 flex flex-col items-center justify-center text-center">
            ...
            <a href="/pcbuild/public/admin/users" class="flex-1 p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 hover:shadow-lg transition-all duration-200 flex flex-col items-center justify-center text-center">
