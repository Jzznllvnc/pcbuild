<div class="relative w-full h-full flex items-center min-h-screen justify-center px-4 sm:px-6 lg:px-8 pt-60 pb-72" style="background-image: url('/assets/images/CraftWisebg.png'); background-size: cover; background-position: center;">
    <div class="relative z-10 p-8 sm:p-10 bg-white shadow-2xl rounded-xl w-full max-w-md mx-auto">
        ...
        <form action="/login" method="POST" class="space-y-6">
            ...
            <div class="text-sm text-right">
                <a href="/forgot-password" class="font-medium text-[--color-primary-orange] hover:text-[#e76c3e] hover:underline">Forgot password?</a>
            </div>
            <div>
                <button type="submit"
        ...
        <div class="mt-8 text-center">
            <p class="text-md text-gray-700">Don't have an account?
                <a href="/register" class="font-bold text-[--color-dark-blue] hover:text-[#1a2d3a] hover:underline">Register here</a>
            </p>
        </div>
    </div>
</div>