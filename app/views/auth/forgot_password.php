<div class="relative w-full h-full flex items-center justify-center px-4 pt-20 sm:px-6 lg:px-8 bg-cover bg-center min-h-screen" style="background-image: url('/assets/images/CraftWisebg.png'); background-size: cover; background-position: center;">
