<div class="relative w-full h-full flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-cover min-h-screen bg-center pt-40 pb-72" style="background-image: url('/assets/images/CraftWisebg.png'); background-size: cover; background-position: center;">
