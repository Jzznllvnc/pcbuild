<div class="relative w-full h-full flex items-center min-h-screen justify-center px-4 sm:px-6 lg:px-8 pt-40 pb-32" style="background-image: url('/assets/images/CraftWisebg.png'); background-size: cover; background-position: center;">
