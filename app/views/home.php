...
<div class="bg-white py-12 brand-carousel-section">
    ...
    <div class="overflow-hidden relative py-4">
        <div class="flex whitespace-nowrap animate-slide-brands">
            <?php
            $brands_with_images = [
                ['name' => 'AMD', 'logo_url' => '/assets/brands/amd.png'],
                ['name' => 'NVIDIA', 'logo_url' => '/assets/brands/nvidia.png'],
                ['name' => 'Corsair', 'logo_url' => '/assets/brands/corsair.png'],
                ['name' => 'ASUS', 'logo_url' => '/assets/brands/asus.png'],
                ['name' => 'Samsung', 'logo_url' => '/assets/brands/samsung.png'],
                ['name' => 'NZXT', 'logo_url' => '/assets/brands/nzxt.png'],
                ['name' => 'Asrock', 'logo_url' => '/assets/brands/asrock.png'],
                ['name' => 'Intel', 'logo_url' => '/assets/brands/intel.png'],
                ['name' => 'G.Skill', 'logo_url' => '/assets/brands/gskill.png'],
                ['name' => 'MSI', 'logo_url' => '/assets/brands/msi.png'],
                ['name' => 'Seasonic', 'logo_url' => '/assets/brands/seasonic.png'],
                ['name' => 'Western Digital', 'logo_url' => '/assets/brands/westernd.png'],
                ['name' => 'Lian Li', 'logo_url' => '/assets/brands/lianli.png'],
                ['name' => 'Noctua', 'logo_url' => '/assets/brands/noctua.png'],
                ['name' => 'DeepCool', 'logo_url' => '/assets/brands/deepcool.png'],
                ['name' => 'LG', 'logo_url' => '/assets/brands/lg.png'],
                ['name' => 'Razer', 'logo_url' => '/assets/brands/razer.png'],
                ['name' => 'Logitech', 'logo_url' => '/assets/brands/logitech.png'],
                ['name' => 'EVGA', 'logo_url' => '/assets/brands/evga.png'],
                ['name' => 'Crucial', 'logo_url' => '/assets/brands/crucial.png'],
                ['name' => 'Fractal Design', 'logo_url' => '/assets/brands/fractal.png'],
                ['name' => 'GIGABYTE', 'logo_url' => '/assets/brands/gigabyte.png'],
                ['name' => 'Kingston', 'logo_url' => '/assets/brands/kingston.png'],
            ];
