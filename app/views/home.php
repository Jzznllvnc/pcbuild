...
<div class="bg-white py-16">
    <div class="container mx-auto px-4 text-center">
        ...
        <h2 class="text-5xl sm:text-6xl font-extrabold text-gray-900 mb-20 leading-tight">
            BUILD YOUR <span class="text-[--color-primary-orange]">DREAM PC</span> <br>IN 3 SIMPLE STEPS
        </h2>

        <div class="grid grid-cols-1 md:grid-cols-3 border border-gray-200 rounded-lg overflow-hidden max-w-5xl mx-auto">
            <div class="px-8 py-16 border-b md:border-b-0 md:border-r border-gray-200 flex flex-col items-center text-center">
