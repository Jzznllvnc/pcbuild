...
class UserController extends BaseController
{
    ...
    public function updateGeneralInformation()
    {
        ...
        if ($updated) {
            ...
            header('Location: /profile?success_msg=' . urlencode('Profile updated successfully!'));
            exit();
        } else {
            header('Location: /profile?error_msg=' . urlencode('Failed to update profile. Please try again.'));
            exit();
        }
    ...
    public function updatePhoneNumber()
    {
        ...
        if ($updated) {
            header('Location: /profile?success_msg=' . urlencode('Phone number updated successfully!'));
            exit();
        } else {
            header('Location: /profile?error_msg=' . urlencode('Failed to update phone number. Please try again.'));
            exit();
        }
