        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-col md:flex-row justify-around items-center md:items-start text-center md:text-left space-y-8 md:space-y-0">
                ...
                <div class="flex-shrink-0 md:w-1/4">
                    <h3 class="text-2xl font-bold text-white mb-2">PCBuilder Pro</h3>
                ...
                <div class="flex-shrink-0 md:w-1/4 md:text-right">
                    ...
                    <div class="flex justify-center md:justify-end space-x-4 pr-4"> <!-- Added pr-4 for right padding -->
                        <a href="#" class="text-[--footer-text-light] hover:text-[--footer-link-hover] transition-colors" aria-label="Facebook">
                        ...
                        <a href="#" class="text-[--footer-text-light] hover:text-[--footer-link-hover] transition-colors" aria-label="Twitter">
                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        <a href="#" class="text-[--footer-text-light] hover:text-[--footer-link-hover] transition-colors" aria-label="Instagram">
                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <div id="ai-chat-sidebar">
        <div class="sidebar-header">
            <h2 class="text-xl font-bold">AI PC Assistant</h2>
