...
<body class="min-h-screen flex flex-col">
    <header class="main-header text-white p-4 fixed top-0 w-full z-50">
        <nav class="container mx-auto flex justify-between items-center relative">
            <a href="/" class="text-2xl font-bold rounded-md px-3 py-1 hover:bg-gray-700 transition-colors flex items-center">
            ...
            <div class="desktop-nav-links items-center space-x-4">
                <?php if (isset($_SESSION['user_id'])): ?>
                    <a href="/products" class="rounded-md px-3 py-2 text-sm font-medium hover:bg-gray-700 transition-colors">All Products</a>
                    <a href="/orderhistory" id="order-history-link" class="relative rounded-md px-3 py-2 text-sm font-medium hover:bg-gray-700 transition-colors flex items-center">
                        Order History
                    ...
                    <a href="/build-rate" class="rounded-md px-3 py-2 text-sm font-medium hover:bg-gray-700 transition-colors">Rate Your Build</a>

                    <a href="/cart" class="relative rounded-md px-3 py-2 text-sm font-medium hover:bg-gray-700 transition-colors flex items-center">
                    ...
                    <div class="w-4"></div> <?php if (isset($_SESSION['is_admin']) && $_SESSION['is_admin']): ?>
                        <a href="/admin/dashboard" class="rounded-md px-3 py-2 text-sm font-medium hover:bg-gray-700 transition-colors">
                            Administration
                        </a>
                    <?php else: ?>
                        <a href="/profile" class="rounded-md px-3 py-2 text-sm font-medium hover:bg-gray-700 transition-colors">
                            Manage Profile
                        </a>
                    <?php endif; ?>
                ...
                <?php else: ?>
                    ...
                    <div class="w-4"></div> <a href="/login" class="bg-[--color-primary-orange] hover:bg-[#e76c3e] text-white font-bold py-2 px-4 rounded-md shadow-lg transition-colors">Login / Register</a>
                <?php endif; ?>
            </div>
            ...
            <div class="mobile-nav-actions md:hidden">
                <?php if (isset($_SESSION['user_id'])): ?>
                    <?php if (isset($_SESSION['is_admin']) && $_SESSION['is_admin']): ?>
                        <a href="/admin/dashboard" class="rounded-md px-2 py-1 text-sm font-medium hover:bg-gray-700 transition-colors sm-custom-hidden-below">
                            Administration
                        </a>
                    <?php else: ?>
                        <a href="/profile" class="rounded-md px-2 py-1 text-sm font-medium hover:bg-gray-700 transition-colors sm-custom-hidden-below">
                            Manage Profile
                        </a>
                    <?php endif; ?>
                ...
                <?php else: ?>
                    <a href="/login" class="bg-[--color-primary-orange] hover:bg-[#e76c3e] text-white font-bold py-1 px-2 rounded-md shadow-lg transition-colors text-sm sm-custom-hidden-below">Login / Register</a>
                <?php endif; ?>
        ...
        <div id="mobile-menu" class="mobile-menu md:hidden">
            <a href="/products" class="block">All Products</a>
            <a href="/orderhistory" class="block relative">
                Order History
            ...
            <a href="/build-rate" class="block">Rate Your Build</a>
            ...
            <?php if (isset($_SESSION['user_id'])): ?>
                <a href="<?php echo (isset($_SESSION['is_admin']) && $_SESSION['is_admin']) ? '/admin/dashboard' : '/profile'; ?>" class="block sm-custom-hidden-up">
            ...
            <?php else: ?>
                <a href="/login" class="block sm-custom-hidden-up">Login / Register</a>
            <?php endif; ?>
        </div>
